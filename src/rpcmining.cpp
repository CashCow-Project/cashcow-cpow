...
Value getmininginfo(const Array& params, bool fHelp)
{
    ...
    obj.push_back(Pair("stakevalue",    (uint64_t)COIN_STAKE_REWARD));
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "CashCow is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "CashCow is downloading blocks...");
