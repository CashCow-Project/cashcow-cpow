...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BlankCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"rat4.blankcoin.co", "seed.blankcoin.co"},
    {"maarx.blankcoin.co", "seed2.blankcoin.co"},
...
void ThreadDNSAddressSeed(void* parg)
{
    ...
    RenameThread("blankcoin-dnsseed");
...
void ThreadDumpAddress(void* parg)
{
    ...
    RenameThread("blankcoin-adrdump");
...
void ThreadOpenConnections(void* parg)
{
    ...
    RenameThread("blankcoin-opencon");
...
void ThreadMessageHandler(void* parg)
{
    ...
    RenameThread("blankcoin-msghand");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BlankCoin is probably already running."), addrBind.ToString().c_str());
        else
